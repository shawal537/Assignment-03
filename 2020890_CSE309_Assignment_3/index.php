        ...
        <div class="row">
            ...
            <div class="col-md-5 part bg-dark p-5 text-white">
                ...
                <div class="textlist">
                    ...
                    <p>537No Pearabagh Jame Masjid <br>Moghbajar, Dhaka</p>
                </div>
                ...
                <div class="textlist">
                    ...
                    <p class="text">shawalbinte537@gmail.com</p>
                </div>
            ...
            <div class="col-md-7 p-5 justify-content-center">
                ...
                <h2 class="head">Tell Us What's in Your Mind</h2>

                <form action="contactus.php" method="post" class="row g-3 contactForm mt-4">
                    <label for="" class="form-label">YOUR IDENTITY PLEASE *</label>
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="fname" id="fname" placeholder="Enter your Fast Name" required>
                    </div>
                    <div class="col-md-6">
